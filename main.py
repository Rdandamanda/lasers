    ...
    match item_type:
        ...
        case "Zdroj 8 paprsků":
            for source in create_ray_star(100, 100, 0, 8):
                screen.ray_sources.append(source)
        case "Zdroj 16 paprsků":
            for source in create_ray_star(100, 100, 0, 16):
                screen.ray_sources.append(source)
        case "Zdroj 32 paprsků":
            for source in create_ray_star(100, 100, 0, 32):
                screen.ray_sources.append(source)
        case "Zdroj 64 paprsků":
            for source in create_ray_star(100, 100, 0, 64):
                screen.ray_sources.append(source)
        case _:
